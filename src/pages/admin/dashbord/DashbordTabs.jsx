...
function DashboardTab() {
  ...
  const handleStatusChange = async (index, status) => {
    ...
    updatedOrder[index].status = status;
    setOrder(updatedOrder);
    setLoading(true);
    try {
      const orderDoc = doc(fireDB, "orders", updatedOrder[index].id);
      await setDoc(orderDoc, { ...updatedOrder[index], status });
      setLoading(false);
    } catch (error) {
      ...
      <div className="container mx-auto">
        <div className="tab container mx-auto ">
          <Tabs defaultIndex={0} className=" ">
            <TabList className="md:flex md:space-x-8 bg-  grid grid-cols-2 text-center gap-4   md:justify-center mb-10 mt-4">
              <Tab>
                <button
                  type="button"
                            ...
                            <td className="px-6 py-4">
                              <div className=" flex gap-2">
                                ...
                                >
                                  ...
                                  <Link
                                    to={"/updateproduct"}
                                    onClick={() => edithandle(item)} // Wrap in an anonymous function
                                  >
                                    <div>
                                      <svg
                                        xmlns="http://www.w3.org/2000/svg"
